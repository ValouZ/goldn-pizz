    ...
    <div class="columns-desktop">
      <div class="left-desktop">
        <!-- <section class="update-input app-update update-input--profile" aria-label="Changer son sexe">
          <input type="text" id='sexe' name="civilite" value="<?php
        ...
        <section class="update-input app-update update-input--profile" aria-label="Changer le pseudo">
          <input type="text" id='pseudo' name="pseudo" value="<?= $clientInfo['pseudo_client'] ?>" disabled="true">
          <label for="pseudo">
            Pseudo
          </label>
          <button class="update-input__button">
        ...
        <section class="update-input app-update update-input--profile" aria-label="Changer son mail">
          <input type="email" id='email' name="email" value="<?= $clientInfo['email_client'] ?>" disabled="true">
          <label for="email">
            Email
          </label>
          <button class="update-input__button">
        ...
        <section class="update-input app-update update-input--profile" aria-label="Changer de pays">
          <input type="text" id='country' name="country" value="<?= $clientInfo['pays_client'] ?>" disabled="true">
          <label for="country">
            Pays
          </label>
          <button class="update-input__button">
      ...
      <div class="right-desktop">
        <section class="update-input app-update update-input--profile" aria-label="Changer de ville">
          <input type="text" id='city' name="city" value="<?= $clientInfo['ville_client'] ?>" disabled="true">
          <label for="city">
            Ville
          </label>
          <button class="update-input__button">
        ...
        <section class="update-input app-update update-input--profile" aria-label="Changer de code postal">
          <input type="text" id='postcode' name="postcode" value="<?= $clientInfo['postcode_client'] ?>" disabled="true">
          <label for="postcode">
            Code postal
          </label>
          <button class="update-input__button">
        ...
        <section class="update-input app-update update-input--profile" aria-label="Changer de rue">
          <input type="text" id='street' name="street" value="<?= $clientInfo['rue_client'] ?>" disabled="true">
          <label for="street">
            Rue
          </label>
          <button class="update-input__button">
        ...
        <section class="update-input app-update update-input--profile" aria-label="Changer de numéro de téléphone">
          <input type="tel" placeholder="Numéro de téléphone" pattern="[0-9]{10}" name="phone" value="<?= $clientInfo['tel_client'] ?>" disabled="true">
          <label for="street">
            Numéro de téléphone
          </label>
          <button class="update-input__button">
